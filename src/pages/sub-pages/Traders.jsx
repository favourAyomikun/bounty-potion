...
const Traders = () => {
  ...
  <tr>
    <th className="py-4 px-4 font-bold text-xs md:text-[13px] text-white align-middle">Rank</th>
    <th className="py-4 px-4 font-bold text-xs md:text-[13px] text-white align-middle">Trader</th>
    ...
    <th className="py-4 px-4 font-bold text-xs md:text-[13px] text-white align-middle">Share</th>
  </tr>
</thead>
