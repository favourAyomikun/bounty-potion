      ...
      <div className="overflow-x-auto">
        <table className="w-full">
          <thead className="bg-[#25223D] text-gray-400 text-xs md:text-[13px]">
            <tr>
              <th className="py-2 md:py-4 px-2 md:px-4 font-bold text-xs md:text-[13px] text-white align-middle">Rank</th>
              <th className="py-2 md:py-4 px-2 md:px-4 font-bold text-xs md:text-[13px] text-white align-middle">Trader</th>
              <th className="py-2 md:py-4 px-2 md:px-4 font-bold text-xs md:text-[13px] text-white align-middle">
              ...
              <th className="py-2 md:py-4 px-2 md:px-4 font-bold text-xs md:text-[13px] text-white align-middle">Share</th>
            </tr>
          </thead>
